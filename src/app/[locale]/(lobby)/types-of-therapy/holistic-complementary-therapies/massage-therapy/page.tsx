...
export default function MassageTherapyPage() {
  const t = useTranslations("MassageTherapyPage")

  return (
    <>
      <section className="bg-muted -mt-20 border-b bg-[url(/images/massage-therapy.webp)] bg-center">
