...
export default function PersonalTrainerPage() {
  const t = useTranslations("PersonalTrainerPage")

  return (
    <>
      <section className="bg-muted -mt-20 border-b bg-[url(/images/training.webp)] bg-center">
