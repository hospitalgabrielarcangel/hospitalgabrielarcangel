...
export default function TypesOfTherapyPage() {
  const t = useTranslations("TypesOfTherapyPage")
  ...
  return (
    <>
      <section className="flex w-full flex-col items-stretch border-t md:flex-row">
        <div className="flex flex-col md:w-1/2">
          ...
          <article>
            ...
            <ul>
              {typeOfTherapyConfig.map((typeOfTherpayItem) => (
                <li
      ...
      <PageSection
        ...
        heading={t("techHeading")}
        description={t("techDescription")}
        link={{
          to: "tech",
        }}
        image={{
          src: "/images/tms_device.webp",
          alt: "",
          width: 1080,
          height: 1350,
        }}
