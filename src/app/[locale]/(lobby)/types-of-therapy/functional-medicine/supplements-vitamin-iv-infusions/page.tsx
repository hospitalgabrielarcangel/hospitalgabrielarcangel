...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale: locale,
    namespace: "SupplementsVitaminIVInfusionsPage",
  })
...
export default function SupplementsVitaminIVInfusionsPage() {
  const t = useTranslations("SupplementsVitaminIVInfusionsPage")

  return (
    <>
      <section className="bg-muted -mt-20 border-b bg-[url(/images/iv-infusions.webp)] bg-center">
