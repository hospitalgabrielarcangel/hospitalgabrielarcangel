...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale: locale,
    namespace: "TraumaFocusedTherapyPage",
  })
...
export default function TraumaFocusedTherapyPage() {
  const t = useTranslations("TraumaFocusedTherapyPage")

  return (
    <>
      <section className="bg-muted -mt-20 border-b bg-[url(/images/trauma-focused-therapy.webp)] bg-center">
