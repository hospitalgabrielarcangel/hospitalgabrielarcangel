...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale: locale,
    namespace: "FamilyPsychotherapyPage",
  })
...
export default function FamilyPsychotherapyPage() {
  const t = useTranslations("FamilyPsychotherapyPage")

  return (
    <>
      <section className="bg-muted -mt-20 border-b bg-[url(/images/family-psychotherapy.webp)] bg-center">
