...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale: locale,
    namespace: "DialecticalBehaviourPage",
  })
...
export default function DialecticalBehaviourPage() {
  const t = useTranslations("DialecticalBehaviourPage")

  return (
    <>
      <section className="bg-muted -mt-20 border-b bg-[url(/images/grupal-therapy.webp)] bg-center">
