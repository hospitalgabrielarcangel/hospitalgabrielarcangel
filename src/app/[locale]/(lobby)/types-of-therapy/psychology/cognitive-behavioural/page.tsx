...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale: locale,
    namespace: "CognitiveBehaviouralPage",
  })
...
export default function CognitiveBehaviouralPage() {
  const t = useTranslations("CognitiveBehaviouralPage")

  return (
    <>
      <section className="bg-muted -mt-20 border-b bg-[url(/images/therapy-room.webp)] bg-center">
