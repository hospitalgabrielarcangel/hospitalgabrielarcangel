...
export default function DentistryPage() {
  const t = useTranslations("DentistryPage")

  return (
    <>
      <section className="bg-muted -mt-20 border-b bg-[url(/images/dentist.webp)] bg-center object-cover">
